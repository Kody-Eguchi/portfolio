import nourishd from '../../assets/images/nourishd.png';
import quiz from '../../assets/images/quiz-app.png';
import tweeter from '../../assets/images/tweeter-app.png';
import scheduler from '../../assets/images/scheduler-app.png';
import tinyApp from '../../assets/images/tiny-app.png';
import romantech from '../../assets/images/romantech.png';
import dishcover from '../../assets/images/dishcover.png';
...
function Work() {
  return (
    <div>
      <Carousel className='w-75 mx-auto my-5 d-none d-md-block'>
          <div>
            <img src={nourishd} />
            <div className="legend bg-white d-flex flex-column gap-3 pb-4">
              ...
              <div>
              <p className='text-dark fs-5'>Tech Stack</p>
                <i className="mx-1 fs-5 text-white bg-secondary rounded p-2 devicon-html5-plain"></i>
                <i className="mx-1 fs-5 text-white bg-secondary rounded p-2 devicon-css3-plain"></i>
                <i className="mx-1 fs-5 text-white bg-secondary rounded p-2 devicon-javascript-plain"></i>
                <i className="mx-1 fs-5 text-white bg-secondary rounded p-2 devicon-react-original"></i>
                <i className="mx-1 fs-5 text-white bg-secondary rounded p-2 devicon-rails-plain"></i>
                <i className="mx-1 fs-5 text-white bg-secondary rounded p-2 devicon-postgresql-plain"></i>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="legend bg-white d-flex flex-column gap-3 pb-4">
              ...
              <p className='text-dark fs-5'>Tech Stack</p>
                ...
                <i className="mx-1 fs-5 text-white bg-secondary rounded p-2 devicon-javascript-plain"></i>
                <i className="mx-1 fs-5 text-white bg-secondary rounded p-2 devicon-jquery-plain"></i>
                <i className="mx-1 fs-5 text-white bg-secondary rounded p-2 devicon-postgresql-plain"></i>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="legend bg-white d-flex flex-column gap-3 pb-4">
              ...
              <p className='text-dark fs-5'>Tech Stack</p>
                <i className="mx-1 fs-5 text-white bg-secondary rounded p-2 devicon-html5-plain"></i>
                <i className="mx-1 fs-5 text-white bg-secondary rounded p-2 devicon-css3-plain"></i>
                <i className="mx-1 fs-5 text-white bg-secondary rounded p-2 devicon-tailwindcss-plain"></i>
                <i className="mx-1 fs-5 text-white bg-secondary rounded p-2 devicon-javascript-plain"></i>
                <i className="mx-1 fs-5 text-white bg-secondary rounded p-2 devicon-vuejs-plain"></i>
                <i className="mx-1 fs-5 text-white bg-secondary rounded p-2 devicon-rails-plain"></i>
              </div>
            </div>
          </div>
